...
/**
 * this class is base for Store class.
 */
@interface KOStoreFmdbBase : NSObject{
    @private
...
// !!!: methods which is below here is with underscore as prefix. these don`t want to be used except Store Layer, becase these depend on sql , ResultSet ,and so on.
